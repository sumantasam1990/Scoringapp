                                            ...
                                            <td>
                                                <div class="text-left mt-4">
                                                    @php
                                                        ...
                                                        WHERE subjects.id = ? AND applicants.id = ? AND criterias.id = ?", [$subjects[0]->subject->id,$applicant->id,$data->id]);
                                                    ...
                                                    @foreach ($results as $result)
                                                        ...
                                                        @if ($result->score_number == 1)
                                                            <label class="btn score-priority" style="background-color: #FC0A0A; border: 3px solid #FC0A0A; width: 100%; height: 30px; color: #fff; font-weight: bold; margin-left: -3px;"></label>
                                                        @elseif ($result->score_number == 2)
                                                            <label class="btn score-priority" style="background-color: #F56A21; border: 3px solid #F56A21; width: 100%; height: 30px; color: #fff; font-weight: bold; margin-left: -3px;"></label>
                                                        @elseif ($result->score_number == 3)
                                                            <label class="btn score-priority" style="background-color: #FCD40A; border: 3px solid #FCD40A; width: 100%; height: 30px; color: #fff; font-weight: bold; margin-left: -3px;"></label>
                                                        @elseif ($result->score_number == 4)
                                                            <label class="btn score-priority" style="background-color: #40F328; border: 3px solid #40F328; width: 100%; height: 30px; color: #fff; font-weight: bold; margin-left: -3px;"></label>
                                                        @elseif ($result->score_number == 5)
                                                            <label class="btn score-priority" style="background-color: #138D07; border: 3px solid #138D07; width: 100%; height: 30px; color: #fff; font-weight: bold; margin-left: -3px;"></label>
                                                        @endif
