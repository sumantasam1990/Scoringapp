...
<div class="container mt-6">
    ...
    <div class="row">
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8">
            ...
            <h2 class="display-4 text-left heading_txt">States Dashboard
...
{{--                    data-bs-placement="top" data-bs-content="" class="fas fa-info-circle"></i>--}}
            ...
            <p>Choose the state where you are an agent.</p>

            <ul class="list-group mt-4">
                @foreach($states as $state)
                    <a class="list-group-item list-group-item-action" href="{{ route('metro.dashboard', $state->id) }}"> {{ $state->name }}</a>
                @endforeach
            </ul>
