    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="fw-bold display-5">Save Tons Of Time</h4>
                <p>No more going back and fourth between Agents and Clients about whether the Clients like the house or not. <br> With our features & detailed data, Agents can save tons of time by finding a house that Buyers love the most, faster and more efficiently.</p>
...
<div class="container-fluid cta-red mt-6 container-home">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h4 class="fw-bold display-5">Huge Benefit For Clients.</h4>
                <p>Scorng will enable buyers themselves, to pick the best house because they will be able to see an objective, <br> super detailed and comprehensive score for each house that they otherwise wouldn't and pick the best house.</p>
