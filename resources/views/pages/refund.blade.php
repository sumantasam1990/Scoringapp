...
<div class="container mt-6">
    <div class="row">
        <div class="col-12">
            ...
            <p class="mt-4 fs-4">
                At the end of the day, nearly everything on the edges comes down to a case-by-case basis. <a href="mailto:hello@scorng.com" class="text-dark text-decoration-underline">Send us a note</a>, tell us what’s up, and we’ll work with you to make sure you’re happy.
            </p>
